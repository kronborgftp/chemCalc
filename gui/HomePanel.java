...
public class HomePanel extends JPanel {
    ...
    private static final Object[][] GROUPS = {
        ...
        {"Redox", "redox", new Object[][]{
            {"Oxidation States",        "Assign ox. states by rules (F, O, H, group metals)",  0},
            {"Balance Half-Rxn (Acid)", "Balance half-reactions in acidic solution",            1},
            {"Balance Half-Rxn (Base)", "Balance half-reactions in basic solution",             2},
            {"Combine Half-Reactions",  "Find LCM of electrons and multipliers",                3},
            {"Galvanic Cell E°",        "E°cell = E°cathode − E°anode, ΔG°, K",               4},
            {"Formal Charge",           "FC = V − L − B/2 for up to 4 atoms",                  5},
        }},
