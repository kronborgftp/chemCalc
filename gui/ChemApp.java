...
public class ChemApp extends JFrame {
    ...
    static final String[][] ALL_CALCS = {
        ...
        {"Oxidation States",         "Assign ox. states by rules (F, O, H, group metals)",        "redox",    "0"},
        {"Balance Half-Rxn (Acid)",  "Balance half-reactions in acidic solution",                 "redox",    "1"},
        {"Balance Half-Rxn (Base)",  "Balance half-reactions in basic solution",                  "redox",    "2"},
        {"Combine Half-Reactions",   "Find LCM of electrons and multipliers",                     "redox",    "3"},
        {"Galvanic Cell E°",         "E°cell = E°cathode − E°anode, ΔG°, K",                     "redox",    "4"},
        {"Formal Charge",            "FC = V − L − B/2 for up to 4 atoms",                       "redox",    "5"},
